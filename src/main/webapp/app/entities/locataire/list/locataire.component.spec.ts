...
import { sampleWithRequiredData } from '../locataire.test-samples';
...
describe('Locataire Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.locataires()[0]).toEqual(expect.objectContaining({ id: 3768 }));
  });

  describe('trackId', () => {
    it('should forward to locataireService', () => {
      const entity = { id: 3768 };
      jest.spyOn(service, 'getLocataireIdentifier');
      const id = comp.trackId(entity);
      expect(service.getLocataireIdentifier).toHaveBeenCalledWith(entity);
