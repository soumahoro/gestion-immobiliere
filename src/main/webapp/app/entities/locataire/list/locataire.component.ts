...
import { EntityArrayResponseType, LocataireService } from '../service/locataire.service';
...
export class LocataireComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.locataires.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: ILocataire[] | null): ILocataire[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.locataireService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
