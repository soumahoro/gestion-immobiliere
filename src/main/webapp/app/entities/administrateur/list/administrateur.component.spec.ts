...
import { sampleWithRequiredData } from '../administrateur.test-samples';
...
describe('Administrateur Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.administrateurs()[0]).toEqual(expect.objectContaining({ id: 7232 }));
  });

  describe('trackId', () => {
    it('should forward to administrateurService', () => {
      const entity = { id: 7232 };
      jest.spyOn(service, 'getAdministrateurIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAdministrateurIdentifier).toHaveBeenCalledWith(entity);
