...
import administrateurResolve from './administrateur-routing-resolve.service';

describe('Administrateur routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: AdministrateurService;
  let resultAdministrateur: IAdministrateur | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IAdministrateur returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        administrateurResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultAdministrateur).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IAdministrateur>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
