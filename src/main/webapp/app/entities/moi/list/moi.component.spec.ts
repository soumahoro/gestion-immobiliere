...
import { sampleWithRequiredData } from '../moi.test-samples';
import { MoiService } from '../service/moi.service';

import { MoiComponent } from './moi.component';
import SpyInstance = jest.SpyInstance;

describe('Moi Management Component', () => {
  let comp: MoiComponent;
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.mois()[0]).toEqual(expect.objectContaining({ id: 25038 }));
  });

  describe('trackId', () => {
    it('should forward to moiService', () => {
      const entity = { id: 25038 };
      jest.spyOn(service, 'getMoiIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMoiIdentifier).toHaveBeenCalledWith(entity);
