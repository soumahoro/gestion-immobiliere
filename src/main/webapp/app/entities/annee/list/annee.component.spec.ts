...
import { sampleWithRequiredData } from '../annee.test-samples';
...
describe('Annee Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.annees()[0]).toEqual(expect.objectContaining({ id: 21078 }));
  });

  describe('trackId', () => {
    it('should forward to anneeService', () => {
      const entity = { id: 21078 };
      jest.spyOn(service, 'getAnneeIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAnneeIdentifier).toHaveBeenCalledWith(entity);
