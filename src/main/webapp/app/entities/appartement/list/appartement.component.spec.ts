...
import { sampleWithRequiredData } from '../appartement.test-samples';
...
describe('Appartement Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AppartementComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.appartements()[0]).toEqual(expect.objectContaining({ id: 30619 }));
  });

  describe('trackId', () => {
    it('should forward to appartementService', () => {
      const entity = { id: 30619 };
      jest.spyOn(service, 'getAppartementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAppartementIdentifier).toHaveBeenCalledWith(entity);
