...
import { sampleWithRequiredData } from '../reglement.test-samples';
...
describe('Reglement Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.reglements()[0]).toEqual(expect.objectContaining({ id: 13334 }));
  });

  describe('trackId', () => {
    it('should forward to reglementService', () => {
      const entity = { id: 13334 };
      jest.spyOn(service, 'getReglementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getReglementIdentifier).toHaveBeenCalledWith(entity);
