...
import { EntityArrayResponseType, ReglementService } from '../service/reglement.service';
...
export class ReglementComponent implements OnInit {
  ...
  trackId = (item: IReglement): number => this.reglementService.getReglementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.reglements.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IReglement[] | null): IReglement[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.reglementService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
